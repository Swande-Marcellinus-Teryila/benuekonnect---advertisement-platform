        ...
        $categorys = $auth->displayAllWithOrder('category','id','ASC');
...
if(isset($_POST['approve_btn'])){
        ...
        try {
            ...
            $auth->deleteSpecific('category','id',$_POST['id']);
        ...
        <?php include('includes/leftbar.php'); ?>
                                    ...
                                    <div class="page-body">
                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                <h5 class="alert alert-success">Manage Category</h5>
                                                        ...
                                                        <tbody>
                                                         ...
                                                         <?php $i=1; foreach($categorys as $data){ ?>
                                                                ...
                                                                <td><?=$data['category']?>
                                                                 ...
                                                                 <td>
                                                                    <?= $auth->get_time_ago($data['date_uploaded']);?>
                                                                    </td>
           ...
           <form method="post">
               <input type="submit" value="Live" name="approve_btn" class="btn btn-success">
       ...
       <td>
                            ...
                            <a href="edit-category.php?id=<?=$data['id']?>"><i class="fa fa-edit btn btn-primary" title="Edit Record">Edit </i> </a>
