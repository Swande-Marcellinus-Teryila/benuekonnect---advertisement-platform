      ...
      try{   
       ...
       $categories = $auth->displayAll('category');
        ...
        if($_SERVER['REQUEST_METHOD']=='POST'){
          $msg = $auth->insertSubcategory($_POST);
        }
       }catch(Exception $e){
        $error = $e->getMessage();
                                            ...
                                            <div class="col-md-12">
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5 class="alert alert-success k">Add Subcategory</h5>
                                                        <?php if($msg){?> <br><br>
                                                        ...
                                                        <form class="form-material" method="post" id="addcategory" enctype="multipart/form-data">
                                                             <div class="form-group form-success">
                                                               ...
                                                               <div class="form-group form-success" >
                                                                ...
                                                                <p id="showsubcategory" class="alert alert-success">List of Subcategory for the Selected Category</p>
