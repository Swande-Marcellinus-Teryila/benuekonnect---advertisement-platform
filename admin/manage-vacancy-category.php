        ...
        $categorys = $auth->displayAllWithOrder('vacancy_category','vacancy_category','ASC');
...
if(isset($_POST['approve_btn'])){
        ...
        try {
            ...
            $auth->deleteSpecific('vacancy_category','id',$_POST['id']);
       ...
       <td>
                            ...
                            <a href="edit-vacancy-category.php?cat_id=<?=$data['id']?>"><i class="fa fa-edit btn btn-primary" title="Edit Record">Edit </i> </a>
