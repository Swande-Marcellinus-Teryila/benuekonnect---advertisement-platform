      ...
      try{   
       ...
       $categories = $auth->displayAll('category');
        ...
        if($_SERVER['REQUEST_METHOD']=='POST'){
          $msg = $auth->insertVacancyCategory($_POST);
        }
       }catch(Exception $e){
        $error = $e->getMessage();
                                            ...
                                            <div class="col-md-12">
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5 class="alert alert-success k">Add Vacancy Category</h5>
                                                        <?php if($msg){?> <br><br>
                                                    ...
                                                    <div class="card-block">
                                                        <form class="form-material" method="post" id="addcategory" enctype="multipart/form-data">
                                                            ...
                                                            <div class="form-group form-success">
                                                                <input type="text" name="vacancy_category" class="form-control" required="">
