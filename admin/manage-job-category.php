        ...
        $categorys = $auth->displayAllWithOrder('job_categories','job_category','ASC');
...
if(isset($_POST['approve_btn'])){
        ...
        try {
            ...
            $auth->deleteSpecific('job_categories','id',$_POST['id']);
       ...
       <td>
                            ...
                            <a href="edit-job-category.php?cat_id=<?=$data['id']?>"><i class="fa fa-edit btn btn-primary" title="Edit Record">Edit </i> </a>
