         ...
         <img src="../images/icons/logo.png" style="width: 80px; height:40px;"> <b>on</b>
            <ul>
                <li><img src="../images/icons/bullet.png" class="custom-bullet">
                 <a href="whatsapp://send?text=Have you heard of BenueKonnect? 
                 BenueKonnect is a free online platform where you can buy and sell anything(services, skills,products etc). 
                 You can also get jobs and so much more  on benuekonnect,click the link below to get started. its 100% FREE https://www.benuekonnect.com/create-account.php?ref=<?=$user['referral_code']?>">
