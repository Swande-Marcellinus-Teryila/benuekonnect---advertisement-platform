...
<!DOCTYPE html>
	...
	<head>
		...
		<title>products | Benuekonnect</title>
			...
			<div class="row">
				<div class="col-sm-12 padding-right">
					<div class="features_items"><!--features_items-->
						<h2 class="title text-center">Latest Adverts</h2>
					<?php $latestProducts = $crud->displayAllSpecificWithOrderWithLimit('products','status','1','date_uploaded','DESC',6); 
					foreach ($latestProducts as $lproduct) {
					?>
						<div class="col-sm-4" id="id<?=$lproduct['category_id']?>">
